object fSelConta: TfSelConta
  ...
  OnCreate = FormCreate
  TextHeight = 15
  object grSEL: TcxGrid
    Left = 0
    Top = 56
    Width = 1001
    Height = 321
    TabOrder = 0
    object gvSEL: TcxGridDBTableView
      ...
      DataController.DataSource = DM.DSCNT
      ...
      object gvSELcod: TcxGridDBColumn
        Caption = 'C'#243'd.'
      ...
      object gvSELdescr: TcxGridDBColumn
        Caption = 'Conta'
      ...
      object gvSELnrins: TcxGridDBColumn
        Caption = 'CNPJ'
        DataBinding.FieldName = 'nrins'
        PropertiesClassName = 'TcxTextEditProperties'
        Properties.CharCase = ecUpperCase
        Options.FilterRowOperator = foContains
        Width = 125
      end
      object gvSELdsemp: TcxGridDBColumn
        Caption = 'Empresa'
        DataBinding.FieldName = 'dsemp'
        PropertiesClassName = 'TcxTextEditProperties'
        Properties.CharCase = ecUpperCase
        Options.FilterRowOperator = foContains
        Width = 365
