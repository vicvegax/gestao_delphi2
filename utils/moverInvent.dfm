object fMoverInvent: TfMoverInvent
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Mover para nova Loca'#231#227'o E/OU Categoria E/OU Promotor'
  ClientHeight = 449
  ClientWidth = 594
  Color = clBtnFace
  ...
  object chPES: TCheckBox
    Left = 16
    Top = 256
    Width = 105
    Height = 15
    Caption = 'Novo Promotor:'
    TabOrder = 10
    OnClick = chPESClick
  end
end
