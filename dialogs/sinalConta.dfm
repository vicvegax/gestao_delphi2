object fsinalConta: TfsinalConta
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Sinalizar em Conta ou Agendado'
  ClientHeight = 377
  ClientWidth = 673
  Color = clBtnFace
  ...
  object cbSINAL: TComboBox
    ...
    TabOrder = 9
    Text = 'Agendado (A)'
    OnChange = cbSINALChange
    Items.Strings = (
      'Agendado (A)'
      'Em Conta (C)')
  end
  object edNRDOC: TnumeroDocEdit
    Left = 168
    Top = 160
    Width = 145
    Height = 23
    TextHint = '(N'#195'O INFORMADO)'
    TabOrder = 1
    MaxLength = 30
  end
